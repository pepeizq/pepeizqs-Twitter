...
Namespace pepeizq.Twitter.Xaml
    Module TweetBotones
        ...
        Private Sub BotonResponderClick(sender As Object, e As RoutedEventArgs)
            ...
            Else
                nombreGrid = "gridTweetEscribir" + cosas.Tweet.ID + cosas.MegaUsuario.Usuario.ID
            End If
        ...
        Private Sub BotonCompartirTweetClick(sender As Object, e As RoutedEventArgs)
            ...
            ApplicationData.Current.LocalSettings.Values("TweetCompartirDescripcion") = WebUtility.HtmlDecode(cosas.Tweet.TextoCompleto)
