...
Namespace Interfaz
    Module Busqueda
            ...
            If Not usuarios Is Nothing Then
                If usuarios.Length > 0 Then
                    For Each usuario In usuarios
                        gvResultados.Items.Add(BotonUsuario(usuario))
                    Next
                End If
            End If
        ...
        Public Function BotonUsuario(usuario As IUser)
            ...
            AddHandler boton.Click, AddressOf OtroUsuario.CargarClick3
            AddHandler boton.PointerEntered, AddressOf Entra_Basico
            AddHandler boton.PointerExited, AddressOf Sale_Basico
